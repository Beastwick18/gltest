...
void Shader::setUniform3f(const int location, const GLfloat a, const GLfloat b, const GLfloat c) const {
    glUniform3f(location, a, b, c);
}

void Shader::setUniform3f(const int location, const glm::vec3 v) const {
